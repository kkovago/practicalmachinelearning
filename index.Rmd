...
Finally, I find that the first 5 columns of the training data have no predictive values for 'classe'; they are user and time stamp related data. Therefore I remove these columns.
...
The random forest model is the most accurate (99.7%), so I use it to create the prediction, which I display and also write into a file called "predictionResults.txt"
